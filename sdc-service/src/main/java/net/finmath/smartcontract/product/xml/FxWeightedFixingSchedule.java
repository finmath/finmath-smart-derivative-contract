...
public class FxWeightedFixingSchedule {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "fixing", namespace = "http://www.fpml.org/FpML-5/confirmation", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "numberOfFixings", namespace = "http://www.fpml.org/FpML-5/confirmation", type = JAXBElement.class, required = false)
    })
