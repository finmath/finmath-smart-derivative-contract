 ...
 *         &lt;element name="referencePool" type="{http://www.fpml.org/FpML-5/confirmation}ReferencePool"/&gt;
 *         &lt;choice minOccurs="0"&gt;
 *           &lt;sequence&gt;
 ...
 *           &lt;/sequence&gt;
 *           &lt;element name="tranche" type="{http://www.fpml.org/FpML-5/confirmation}Tranche"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class BasketReferenceInformation {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "referencePool", namespace = "http://www.fpml.org/FpML-5/confirmation", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "nthToDefault", namespace = "http://www.fpml.org/FpML-5/confirmation", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "mthToDefault", namespace = "http://www.fpml.org/FpML-5/confirmation", type = JAXBElement.class, required = false),
